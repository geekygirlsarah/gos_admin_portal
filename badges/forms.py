    ...
    class Meta:
        ...
        widgets = {
            "name": forms.TextInput(
                attrs={"class": "form-control", "placeholder": "e.g. Prototyping"}
            ),
            ...
            "description": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                    "placeholder": "Short public description of the badge",
                }
            ),
            "skills_required": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 3,
                    "placeholder": "Visible to students — list skills they must demonstrate",
                }
            ),
            "how_to_earn": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "rows": 4,
                    "placeholder": "Mentor-only — how to test/verify (not shown to students)",
                }
            ),
