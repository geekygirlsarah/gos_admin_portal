        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "welcome_message",
                    models.TextField(
                        default="Welcome to the Girls of Steel application! Use this wizard to apply for one of our upcoming programs. If you started an application earlier, you can resume it below with your application ID.",
