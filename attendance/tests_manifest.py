...
from attendance.models import KioskConfig, AttendanceSession, AttendanceEvent
...
class KioskManifestTests(TestCase):
    ...
    def test_manifest_api_with_data(self):
        ...
        closed_student = Student.objects.create(first_name="Closed", last_name="Student", graduation_year=2025)
        AttendanceSession.objects.create(
            program=self.program,
