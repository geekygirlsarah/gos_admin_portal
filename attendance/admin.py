...
class AttendanceEventAdmin(admin.ModelAdmin):
    list_display = ('occurred_at', 'event_type', 'program', 'student', 'visitor_name', 'rfid_uid', 'kiosk', 'source')
    list_filter = ('program', 'event_type', 'source')
    search_fields = ('visitor_name', 'rfid_uid', 'student__first_name', 'student__last_name')
    date_hierarchy = 'occurred_at'

@admin.register(AttendanceSession)
class AttendanceSessionAdmin(admin.ModelAdmin):
    list_display = ('check_in', 'check_out', 'duration_minutes', 'program', 'student', 'visitor_name', 'is_open')
    list_filter = ('program',)
