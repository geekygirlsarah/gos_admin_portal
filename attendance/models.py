...
class RFIDCard(models.Model):
    ...
    student = models.ForeignKey('programs.Student', on_delete=models.CASCADE, related_name='rfid_cards')
    is_active = models.BooleanField(default=True)
...
class AttendanceEvent(models.Model):
    ...
    program = models.ForeignKey('programs.Program', on_delete=models.PROTECT)
    student = models.ForeignKey('programs.Student', on_delete=models.PROTECT, null=True, blank=True)
    visitor_name = models.CharField(max_length=120, blank=True)
    rfid_uid = models.CharField(max_length=64, blank=True)
    kiosk = models.ForeignKey(KioskDevice, on_delete=models.SET_NULL, null=True, blank=True)
...
class AttendanceSession(models.Model):
    ...
    opened_by_event = models.ForeignKey(AttendanceEvent, on_delete=models.SET_NULL, null=True, blank=True, related_name='+')
    closed_by_event = models.ForeignKey(AttendanceEvent, on_delete=models.SET_NULL, null=True, blank=True, related_name='+')
    created_at = models.DateTimeField(auto_now_add=True)
