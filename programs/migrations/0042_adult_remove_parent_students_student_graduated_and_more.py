...
def migrate_parent_to_adult_and_clean(apps, schema_editor):
    ...
    for p in Parent.objects.all().iterator():
        ...
        first = (
            ...
            or getattr(p, "preferred_first_name", None)
            or "Parent"
        )
        ...
        defaults = {
            ...
            "is_mentor": False,
            "is_alumni": (
                getattr(p, "is_alumni", False) if hasattr(p, "is_alumni") else False
            ),
        }
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True, related_name="adults", to="programs.student"
            ),
        ),
        migrations.AddField(
            model_name="adult",
        ...
        migrations.RunPython(
            migrate_parent_to_adult_and_clean, reverse_code=migrations.RunPython.noop
        ),
        migrations.RunPython(
            reset_adult_pk_sequence, reverse_code=migrations.RunPython.noop
        ),
