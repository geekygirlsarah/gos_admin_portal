    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cell_phone_number', models.CharField(blank=True, max_length=30, null=True)),
                ...
                (
                    'program',
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='applications', to='programs.program'),
                ),
                (
                    'school',
                    models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='applications', to='programs.school'),
                ),
            ],
            options={
                'ordering': ['-created_at'],
