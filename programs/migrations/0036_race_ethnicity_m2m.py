...
def seed_race_ethnicity_options(apps, schema_editor):
    ...
    options = [
        ...
        ('native-hawaiian-or-other-pacific-islander', 'Native Hawaiian or Other Pacific Islander', 6),
        ('white', 'White', 7),
        ('other', 'Other', 99),
    ]
    for key, name, order in options:
        RaceEthnicity.objects.get_or_create(key=key, defaults={'name': name, 'display_order': order})
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(blank=True, related_name='students', to='programs.raceethnicity', verbose_name='Race / Ethnicity'),
        ),
