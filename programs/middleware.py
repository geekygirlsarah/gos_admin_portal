...
class ActiveProgramMiddleware(MiddlewareMixin):
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        try:
            ...
            if (match.app_name == 'programs' or 'programs' in match.view_name) and 'pk' in view_kwargs:
                ...
                if any(x in match.view_name for x in ['program_detail', 'program_edit', 'program_email', 'program_dues', 'program_student', 'program_assignment', 'program_schools']):
