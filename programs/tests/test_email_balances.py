...
from programs.models import Program, Student, Enrollment, Fee, Adult
...
class EmailBalancesTest(TestCase):
    def setUp(self):
        ...
        self.program = Program.objects.create(name="Test Program", year=2024, active=True)
        ...
        self.a1 = Adult.objects.create(first_name="P1", last_name="A1", personal_email="a1@example.com", email_updates=True)
        ...
        self.a2 = Adult.objects.create(first_name="P2", last_name="A2", personal_email="a2@example.com", email_updates=True)
        ...
        self.a3 = Adult.objects.create(first_name="P3", last_name="A3", personal_email="a3@example.com", email_updates=True)
        ...
        Payment.objects.create(student=self.s3, program=self.program, amount=Decimal("50.00"), paid_via="cash", paid_on=timezone.now().date())
    ...
    def test_view_post_all(self):
        ...
        self.assertRedirects(response, reverse('program_dues_owed', args=[self.program.id]))
