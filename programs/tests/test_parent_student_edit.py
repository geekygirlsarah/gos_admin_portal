...
class ParentStudentEditTests(TestCase):
    def setUp(self):
        ...
        RolePermission.objects.update_or_create(
            role="Parent", section="student_info", defaults={"can_read": True, "can_write": False}
        )
    ...
    def test_parent_can_edit_child_student_if_can_write_is_true(self):
        ...
        RolePermission.objects.filter(role="Parent", section="student_info").update(can_write=True)
